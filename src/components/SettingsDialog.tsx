  ...
  const handleSave = () => {
    ...
    toast({
      ...
      description: apiKey.trim()
        ? "Using your Gemini API key for free deobfuscation."
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Use your own free Google Gemini API key to bypass usage limits, or stick with the built-in AI.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              {" "}— Gemini 2.5 & 3.0 preview models have generous free quotas.
            </p>
          </div>
        </div>
